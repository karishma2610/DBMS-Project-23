...
<body>
  ...
  <br>
    ...
    <a href="viewAllHostelComplaints.php"
      class="button"><b>All Complaints</b></a>
    <a href="viewAllHostelComplaintsInternet.php"
      class="button"><b>Internet</b></a>
    <a href="viewAllHostelComplaintsHygiene.php"
      class="button"><b>Hygiene</b></a>
    <a href="viewAllHostelComplaintsElectricity.php" class="button" ><b>Electricity</b></a>
    <a href="viewAllHostelComplaintsGeneral.php" 
...
$sql = "SELECT * FROM `hostelcomplaint` where `category`='Electricity'";
