...
<body>
  ...
  <br>
    ...
    <a href="viewAllHostelComplaintsBoys.php" 
      class="button"><b>All Complaints</b></a>
    <a href="viewAllHostelComplaintsBoysInternet.php" 
      class="button"><b>Internet</b></a>
    <a href="viewAllHostelComplaintsBoysHygiene.php" 
      class="button"><b>Hygiene</b></a>
    <a href="viewAllHostelComplaintsBoysElectricity.php" class="button"><b>Electricity</b></a>
    <a href="viewAllHostelComplaintsBoysGeneral.php" 
...
$sql = "SELECT * FROM `hostelcomplaint` where `hostel`='Boys Hostel'";
